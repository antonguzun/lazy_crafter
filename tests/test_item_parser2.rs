...
", ParsedItem {
    ...
    item_base_name: "Battle Lamellar".to_string(),
...
", ParsedItem {
    ...
    item_base_name: "Fugitive Boots".to_string(),
    item_name: "Fugitive Boots".to_string(),
    mods: vec!["LocalIncreasedEvasionAndEnergyShieldAndStunRecovery4".to_string(),
             "IncreasedLife0".to_string(),
